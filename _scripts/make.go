...
const DelveMainPackagePath = "github.com/MadHive/delve/cmd/dlv"
...
`,
	...
	integration 	tests github.com/MadHive/delve/service/test
...
func testSetToPackages(testSet string) []string {
	...
	case "basic":
		return []string{"github.com/MadHive/delve/pkg/proc", "github.com/MadHive/delve/service/test", "github.com/MadHive/delve/pkg/terminal"}

	case "integration":
		return []string{"github.com/MadHive/delve/service/test"}
